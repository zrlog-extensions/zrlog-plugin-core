...
public class PluginProcessRuntime {
    ...
    public PluginProcessRuntime() {
        this(new PluginSessionRegistry());
    }
    ...
    void destroy(String pluginShortName) {
    ...
    void destroyByPluginId(String pluginId, String pluginShortName) {
    ...
    void loadPlugin(final File pluginFile, String pluginId) {
    ...
    Long processIdByPluginId(String pluginId) {
        return processIdMap.get(pluginId);
    }

    Optional<String> runtimeInstanceIdByPluginId(String pluginId) {
