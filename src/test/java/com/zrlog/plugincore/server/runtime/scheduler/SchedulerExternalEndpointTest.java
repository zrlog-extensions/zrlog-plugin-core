...
public class SchedulerExternalEndpointTest {
    ...
    public void shouldUseConfiguredHostBeforeFallback() {
        assertEquals("https://blog.example.com" + SchedulerExternalEndpoint.EXTERNAL_TICK_PATH,
    ...
    public void shouldFallbackToHomeUrlWhenConfiguredHostBlank() {
        assertEquals("http://fallback.example.com" + SchedulerExternalEndpoint.EXTERNAL_TICK_PATH,
                SchedulerExternalEndpoint.tickUrl("  ", "http://fallback.example.com/"));
    }

    @Test
    public void shouldReturnPathWhenNoHostAvailable() {
        assertEquals(SchedulerExternalEndpoint.EXTERNAL_TICK_PATH,
    ...
    public void shouldRepairSingleSlashProtocolHost() {
        assertEquals("http://blog.example.com" + SchedulerExternalEndpoint.EXTERNAL_TICK_PATH,
